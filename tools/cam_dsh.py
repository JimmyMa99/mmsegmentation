...
def main():
    ...
    parser.add_argument('--img', default='/media/ders/mazhiming/mmseg4wsss/mmsegmentation/data/VOCdevkit/VOC2012/JPEGImages/2007_000027.jpg',help='Image file')
    parser.add_argument('--config', default='/media/ders/mazhiming/mmseg4wsss/mmsegmentation/my_config/res50_eps_config.py', help='Config file')
    parser.add_argument('--checkpoint',  default='/media/ders/mazhiming/mmseg4wsss/mmsegmentation/work_dirs/wsss_voc12_res50_cls_seed/iter_10000.pth', help='Checkpoint file')
    parser.add_argument(
        '--out-file',
        default='prediction_dsh.png',
        help='Path to output prediction file')
    parser.add_argument(
        '--cam-file', default='vis_cam_dsh.png', help='Path to output cam file')
    parser.add_argument(
        '--target-layers',
        default='backbone.layer4[2]',
        help='Target layers to visualize CAM')
    parser.add_argument(
        '--category-index', default='21', help='Category to visualize CAM')
    parser.add_argument(
