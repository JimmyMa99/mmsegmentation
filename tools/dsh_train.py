...
def parse_args():
    ...
    parser.add_argument('--config',default='/media/ders/mazhiming/mmseg4wsss/mmsegmentation/my_config/res50_eps_config.py',help='train config file path')#dsh,2024.1.25
